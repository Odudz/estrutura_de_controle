...
const verifyButton = document.getElementById('verificarButton'); 
...
function conectar(){
  for(let a = 0; a < particulasArray.length; a++){
    for(let b = a + 1; b < particulasArray.length; b++){
      let distancia = ((particulasArray[a].x - particulasArray[b].x) ** 2) + ((particulasArray[a].y - particulasArray[b].y) ** 2);
